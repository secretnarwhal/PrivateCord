...
export type EncodingType = "auto" | "binary" | "octal" | "decimal" | "hex" | "base32" | "base64" | "utf8";
...
const DECODE_ENCODING_ORDER: EncodingType[] = ["auto", "binary", "octal", "decimal", "hex", "base32", "base64", "utf8"];
const ENCODE_ENCODING_ORDER: EncodeTarget[] = ["binary", "octal", "decimal", "hex", "base32", "base64", "utf8"];
...
export function autoDetectEncoding(text: string): EncodeTarget | null {
    const t = text.trim();
...
export type DecodeError = "invalid-format" | "too-short" | "no-detection";
...
export async function decode(
    ...
    const res = await decodeWithError(text, encoding);
