...
export const PATHS = {
    ...
    // "motion_photos_auto": the circled A — playback carrying on by itself
    autoplay: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm2.6 13.2-.6-1.7h-3.2l-.6 1.7c-.13.36-.47.6-.85.6-.63 0-1.07-.62-.86-1.21l2.44-6.53c.16-.44.58-.73 1.05-.73h.05c.47 0 .89.29 1.05.73l2.44 6.53c.22.59-.22 1.21-.85 1.21h-.02c-.38 0-.72-.24-.85-.6zM11.35 12h2.3L12.5 8.75 11.35 12z",
    ...
    // "folder": the library browser's own bread and butter
    folder: "M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z",
    // "create_new_folder"
    folderAdd: "M20 6h-8l-1.41-1.41C10.21 4.21 9.7 4 9.17 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-2 8h-2v2c0 .55-.45 1-1 1s-1-.45-1-1v-2h-2c-.55 0-1-.45-1-1s.45-1 1-1h2v-2c0-.55.45-1 1-1s1 .45 1 1v2h2c.55 0 1 .45 1 1s-.45 1-1 1z",
    // "drive_file_move": a folder with an arrow going into it — filing by tag
    folderMove: "M20 6h-8l-1.41-1.41C10.21 4.21 9.7 4 9.17 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-6.65 10.65c-.2-.2-.2-.51 0-.71L14.79 14H10c-.55 0-1-.45-1-1s.45-1 1-1h4.79l-1.44-1.44c-.2-.2-.2-.51 0-.71.2-.2.51-.2.71 0l2.29 2.29c.39.39.39 1.02 0 1.41l-2.29 2.29c-.2.2-.51.2-.71 0z",
    // "arrow_upward": one folder back up
    up: "M13 19V7.83l4.88 4.88c.39.39 1.03.39 1.42 0 .39-.39.39-1.02 0-1.41l-6.59-6.59c-.39-.39-1.02-.39-1.41 0l-6.6 6.58c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0L11 7.83V19c0 .55.45 1 1 1s1-.45 1-1z",
    // "visibility_off": tuck an entry away into the browser's other-files section
    hide: "M12 6.5c2.76 0 5 2.24 5 5 0 .51-.1 1-.24 1.46l3.06 3.06c1.39-1.23 2.49-2.77 3.18-4.53C21.27 7.11 17 4 12 4c-1.27 0-2.49.2-3.64.57l2.17 2.17c.47-.14.96-.24 1.47-.24zM2.71 3.16c-.39.39-.39 1.02 0 1.41l1.97 1.97C3.06 7.83 1.77 9.53 1 11.5 2.73 15.89 7 19 12 19c1.52 0 2.97-.3 4.31-.82l2.72 2.72c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L4.13 3.16c-.39-.39-1.03-.39-1.42 0zM12 16.5c-2.76 0-5-2.24-5-5 0-.77.18-1.5.49-2.14l1.57 1.57c-.03.18-.06.37-.06.57 0 1.66 1.34 3 3 3 .2 0 .38-.03.57-.07l1.57 1.57c-.65.32-1.37.5-2.14.5z",
    // "visibility": and back out of it again
    show: "M12 4C7 4 2.73 7.11 1 11.5 2.73 15.89 7 19 12 19s9.27-3.11 11-7.5C21.27 7.11 17 4 12 4zm0 12.5c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z",
    // "edit": rename
    ...
    // "delete": to the recycle bin, never further
    trash: "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v10zM18 4h-2.5l-.71-.71c-.18-.18-.44-.29-.7-.29H9.91c-.26 0-.52.11-.7.29L8.5 4H6c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1z"
} as const;
        ...
        >
            ...
            <div className={cl("video-overlay")} onClick={e => e.stopPropagation()}>
                ...
                <div className={cl("controls-row")}>
                    ...
                    {!isListener && (
                        <ControlButton
                            label={player.autoplay
                                ? "Autoplay on: keep playing through the library"
                                : "Autoplay off: stop once the queue runs out"}
                            className={player.autoplay ? cl("button-active") : undefined}
                            onClick={() => player.toggleAutoplay()}
                        >
                            <Icon path={PATHS.autoplay} label="autoplay" size={15} />
                            {/* struck through rather than swapped for a second icon, so
                                the two states read as one control in two positions */}
                            {!player.autoplay && <span className={cl("button-slash")} aria-hidden />}
                        </ControlButton>
                    )}
